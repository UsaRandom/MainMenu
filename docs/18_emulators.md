...
- **SNES**: lithium64 - `lithium64.z64`, falling back to [sodium64](https://github.com/Hydr8gon/sodium64/releases) by *Hydr8gon* - `sodium64.z64`
...
> [!NOTE]
> **SNES**: lithium64 is our fork of sodium64, targeting this console. sodium64 sizes its ROM
> cache to fill exactly 4 MB of RDRAM and programs the VI, AI, PI and SI with values a stock N64
> accepts; both are assumptions an FPGA reimplementation is entitled to break. The menu prefers
> `lithium64.z64` and falls back to `sodium64.z64`, so an existing card keeps working.
